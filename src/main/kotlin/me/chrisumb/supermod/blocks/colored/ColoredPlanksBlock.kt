...
object ColoredPlanksBlock : Block(Settings.of(Material.WOOD).strength(2.0f, 2.0f)) {

    init {
        ColorProviderRegistry.BLOCK.register(RGBColorProvider, this)

        defaultState = stateManager.defaultState.withColor1Properties(3, 3, 3)
    }
    ...
    override fun appendProperties(builder: StateManager.Builder<Block, BlockState>) {
        builder.add(propR1, propG1, propB1)
    }
